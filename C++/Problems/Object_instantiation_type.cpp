// if you don't familiar with how to initialize class variable in c++, see this below link:
...
// I don't get exact clear explanation of class object instantiation different type in inside main function
